...
ISSUER_ALLOWED_DOMAINS = {
    ...
    "idbi": {"idbibank.in", "www.idbibank.in", "idbi.bank.in", "www.idbi.bank.in"},
    "federal": {"federalbank.co.in", "www.federalbank.co.in", "federal.bank.in", "www.federal.bank.in", "scapia.cards", "www.scapia.cards"},
